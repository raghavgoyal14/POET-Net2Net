...
from .model_net2net import ModelNet2Net, simulate
from .env_net2net import bipedhard_custom, Env_config
...
class Box2DNicheNet2Net(Niche):
    def __init__(self, env_configs, seed, init='random', stochastic=False):
        self.model = ModelNet2Net(bipedhard_custom)
    ...
    def initial_theta(self):
        if self.init == 'random':
            ...
            return self.model.get_zero_model_params()
        else:
